...
//#endregion
export { ProofHostSurface as $, DEPENDENCY_FREE_ONLY_CONDITION as $a, DeriveResult as $i, UnifiedItemDiagnosis as $n, restatedContentOf as $o, LATEST_SUPPORTED_HOST_VERSION as $r, hostLockContextFromComposedDump as $t, snapshotSessionEvents as A, VerificationContract as Aa, environmentDefaultRepositoryTarget as Ai, CanonicalArgv as An, explanationHasActionResidue as Ao, HostCapabilityEvaluation as Ar, normalizeClause as As, evidenceCoverage as At, carriesCleanupCondition as B, ProposeOutcome as Ba, GoalBoundaryAccess as Bi, ToolCallInput as Bn, isOpenObligation as Bo, HostProfileKind as Br, FirstStepInjection as Bt, progressFingerprint as C, SourceSpan as Ca, RejectedBinding as Ci, commitTreeSnapshotDigest as Cn, QualificationStatus as Co, EXPECTED_HOST_PACKAGES as Cr, requestedTargetMatchesResolved as Cs, scopeCoverageDigest as Ct, SESSION_EVENT_ENVELOPE_INVALID as D, TargetSourceKind as Da, captureClause as Di, parseGitCommandManifest as Dn, clauseAsksOwnQuestion as Do, HOST_CAPABILITY_PACKAGE_GROUPS as Dr, validateActionTarget as Ds, validateProofManifestV2 as Dt, SESSION_API_UNSUPPORTED as E, TargetSource as Ea, ClauseSegment as Ei, gitCommandMatchesTarget as En, clarifiedSpanOf as Eo, GOAL_HOST_PACKAGES as Er, validateActionManifest as Es, validateProofManifest as Et, CLEANUP_CONDITION_RULE_COMPACT as F, ReleaseGateDecision as Fa, segmentClauses as Fi, isRunExecutable as Fn, interpretMessage as Fo, HostCohortSelectionReason as Fr, ManifestIssue as Ft, renderRecoveryPacket as G, proposeRebindOutcome as Ga, AssetInterpretationFact as Gi, extractToolSubject as Gn, legacyQuestionReadingIsInformational as Go, evaluateExternalWaitCapability as Gr, firstStepGuidanceV6 as Gt, closingHint as H, RebindProposal as Ha, effectuateBoundary as Hi, ToolSubject as Hn, isRestatement as Ho, LEGACY_HOST_COHORTS as Hr, LifecyclePhase as Ht, CLEANUP_CONDITION_RULE_SHORT as I, ReleaseObservedIdentity as Ia, BoundaryEffectuation as Ii, parsePwshCommand as In, introducesActionClause as Io, HostLockContext as Ir, OperationVerbEntry as It, PROOF_KINDS as J, rebindResponse as Ja, BoundaryDisposition as Ji, withDurability as Jn, namedActions as Jo, evaluateToolSurfaceCapability as Jr, ActiveProfileHostLock as Jt, ALPHA3_HOST_PACKAGES as K, proposeRebindV042 as Ka, AssetObligation as Ki, isDeterministicCheck as Kn, maskCodeSpans as Ko, evaluateHostCapability as Kr, lifecyclePhase as Kt, DEFAULT_RECOVERY_CHAR_BUDGET as L, ReleaseOperation as La, BoundaryQualification as Li, parseShellCommand as Ln, isExecutableItem as Lo, HostLockEvaluation as Lr, validateManifest as Lt, RC015_HOST_PACKAGES as M, WorkUnit as Ma, extractMethod as Mi, ParsedShell as Mn, hasOrderedCoordination as Mo, HostCapabilityRequest as Mr, sanitizeUrl as Ms, isVerifyingCapability as Mt, RC1_HOST_PACKAGES as N, createProjection as Na, extractOperation as Ni, ShellParseStatus as Nn, hasQuestionScope as No, HostCohort as Nr, sha256 as Ns, COMMAND_SURFACE_MANIFEST as Nt, SessionApiError as O, TargetTuple as Oa, captureItem as Oi, revalidateGitPrestate as On, clauseIsGoverned as Oo, HOST_COHORTS as Or, canonicalizePath as Os, EvidenceFacetCoverage as Ot, CLEANUP_CONDITION_RULE as P, PackageRow as Pa, isInformationalMessage as Pi, canonicalArgvFromCommand as Pn, interpretClause as Po, HostCohortSelection as Pr, CommandSurfaceManifest as Pt, PROOF_PROTOCOL_VERSION_V2 as Q, CapabilityRemedy as Qa, DeriveConfig as Qi, TaskKind as Qn, reportingHeadGoverns as Qo, HostVersionStatus as Qr, combineHostPolicy as Qt, MIN_RECOVERY_CHAR_BUDGET as R, ReleaseSettlement as Ra, BoundaryRequest as Ri, goalCompletionDenial as Rn, isExplanationScope as Ro, HostLockStatus as Rr, ClaimedMessage as Rt, observeAssistantOutcome as S, PersistenceAuthorization as Sa, CheckpointResult as Si, commitIndexSnapshotDigest as Sn, QualificationReason as So, DEFAULT_HOST_LOCK as Sr, requestedTargetAuthorizesMutation as Ss, requiredSubjectsOf as St, v6TestPredicate as T, TargetCaptureStatus as Ta, CaptureScope as Ti, executeRevalidatedGitEffect as Tn, actionVerbMatches as To, ExecutableIdentityBinding as Tr, semanticActionFromText as Ts, sessionQueryV2 as Tt, openItems as U, confirmRebind as Ua, isCurrentAcceptedBoundary as Ui, evidenceFromPersistedToolResult as Un, itemHoldsExecutionAuthority as Uo, bindExecutableIdentity as Ur, claimedBatchHasRealRootInput as Ut, cleanupConditionFor as V, RebindArgs as Va, availableBoundaryQualifications as Vi, ToolResultInput as Vn, isQuestionScopeNeedingReview as Vo, HostToolSurface as Vr, FirstStepPreviewInput as Vt, recoveryDigest as W, proposeRebind as Wa, qualifyBoundary as Wi, extractTextContent as Wn, kindOfScope as Wo, bindLiveGoalCapability as Wr, firstStepGuidance as Wt, PROOF_MANIFEST_DOMAIN_V2 as X, CapabilityFact as Xa, DeferAuthorization as Xi, DiagnosisNextAction as Xn, qualificationOfClause as Xo, selectHostCohort as Xr, TargetHostGraph as Xt, PROOF_KINDS_V2 as Y, replayRebindResult as Ya, BoundaryQualificationKind as Yi, CertificationSupport as Yn, opensWithDirective as Yo, hostVersionFromPackages as Yr, HostProfileError as Yt, PROOF_PROTOCOL_VERSION as Z, CapabilityGap as Za, DelegationRef as Zi, Repairability as Zn, questionHeadsClause as Zo, HostVersionDecision as Zr, auditedForegroundRenderers as Zt, decisionBoundaryKey as _, GuardProjection as _a, classifyUserInteraction as _i, GitEffectRunner as _n, Executee as _o, ACTIVE_HOST_LAUNCHER_VERSION as _r, StatefulAction as _s, proofDigestV2 as _t, CONTROL_RECORD_PREFIX as a, EvidenceRole as aa, evaluateMinimumHostVersion as ai, readActiveHostGraph as an, ProcessFactSource as ao, CAPTURE_V042_NOTICE as ar, ACTION_MANIFEST_VERSION as as, ProofObligation as at, latestAssistantText as b, NeedsReviewFact as ba, isFrozenV042RebindResponse as bi, GitTargetIdentity as bn, InterpretOptions as bo, AuditedExecutable as br, isStatefulAction as bs, proofOperationMatches as bt, NO_PROGRESS_RECORD_PREFIX as c, GoalRef as ca, currentContractDigest as ci, verifyComposedHostLockDump as cn, actionHasCertificationPath as co, PROTOCOL_V4_NOTICE as cr, BOUNDED_ARTIFACT_TYPES as cs, SessionQuery as ct, assessmentAction as d, GuardEvidence as da, AuthorityKind as di, GitAdapterAction as dn, capabilityFactOf as do, applyUpgradeEligibility as dr, SEMANTIC_ACTIONS as ds, bindProofV2ToProjection as dt, DeriveScope as ea, MIN_SUPPORTED_HOST_VERSION as ei, hostLockRowsFromComposedDump as en, DeclaredOperationResult as eo, capabilityRemedyPhrase as er, semanticActionOfScope as es, ProofKind as et, assessmentOutcomePredicate as f, GuardIntegrity as fa, authorityCaptureCounts as fi, GitCommandAccepted as fn, partialFailureOf as fo, deriveProjection as fr, STATEFUL_ACTIONS as fs, canonicalProjection as ft, decideTurnStopping as g, GuardOperation as ga, classifyTaskIntent as gi, GitEffectExecution as gn, DirectiveClass as go, ACTIVE_HOST_COHORT_IDS as gr, SemanticAction as gs, proofDigest as gt, decideTurnBoundary as h, GuardItemStatus as ha, UserInteractionKind as hi, GitCommandRejected as hn, AuthorityDisposition as ho, ACTIVE_HOST_COHORT_ID as hr, SUPPORTED_EVIDENCE_ADAPTERS as hs, proofCapabilityReport as ht, AssistantOutcomeObservation as i, EvidenceParseStatus as ia, compareHostVersions as ii, packageRowsFromPnpmLock as in, ProcessExitStatus as io, relevantEvidence as ir, ACTION_MANIFEST as is, ProofManifestV2 as it, RC015_RC2_HOST_PACKAGES as j, WaitAuthorization as ja, extractArtifactPaths as ji, CanonicalCommandSurface as jn, governedClauseRestrictsExecution as jo, HostCapabilityId as jr, sanitizeClauseText as js, evidenceMatchesItem as jt, V3SessionLike as k, TargetValue as ka, classifyClause as ki, verifiedLinearCommitReadback as kn, clauseIsProtected as ko, HostAuditProvenance as kr, digestStrings as ks, bindingSatisfies as kt, NO_PROGRESS_TURNS_BEFORE_STOP as l, GuardBoundary as la, AuthorityBlock as li, GIT_COMMAND_MANIFEST_IDS as ln, admissibleForRemoval as lo, PROTOCOL_V5_NOTICE as lr, CERTIFICATE_VERSION as ls, SessionQueryV2 as lt, currentActionBases as m, GuardItemKind as ma, TaskIntent as mi, GitCommandParseResult as mn, removalIsPartiallyKnown as mo, rootLocatorFlavor as mr, STOP_PROTOCOL_VERSION_V2 as ms, createProofManifestV2 as mt, projectCoreV2 as n, EvidenceBinding as na, SUPPORTED_HOST_RANGE as ni, inspectTargetHostGraph as nn, DerivedProcessFacts as no, evidenceAvailabilityReason as nr, statefulActionsOfScope as ns, ProofKindV2 as nt, CompletionDisposition as o, ExpectedTransition as oa, parseHostVersion as oi, resolveActiveProfileHostLock as on, ProcessOutcomeReason as oo, DEFAULT_DELEGATION_TOOL_NAMES as or, ActionManifest as os, ProofObligationV2 as ot, classifyCompletionClaim as p, GuardItem as pa, segmentAuthorityBlocks as pi, GitCommandManifest as pn, removalIsComplete as po, legacyRecordsNeedingReview as pr, STOP_PROTOCOL_VERSION as ps, createProofManifest as pt, PROOF_CAPABILITY_MATRIX as q, rebindAttemptKey as qa, BindingActionClosure as qi, persistedToolResultStatus as qn, maskQuotedSpans as qo, evaluateHostLock as qr, previewFirstStepInjection as qt, supersedeItem as r, EvidenceOutcome as ra, SUPPORTED_HOST_VERSIONS as ri, packageRowsFromActiveGraph as rn, OperationAttribution as ro, itemDiagnosis as rr, verbIsNegated as rs, ProofManifest as rt, CurrentActionBasis as s, ExternalOperation as sa, satisfiesSupportedHostRange as si, resolveInstalledHostLock as sn, RemovalOutcomeReport as so, PROTOCOL_V3_NOTICE as sr, ActionSpec as ss, ProofSurface as st, projectSessionCoreV2 as t, DerivedEnvelope as ta, ParsedHostVersion as ti, injectActiveProfileHostLock as tn, DependencyStatus as to, deriveItemDiagnosis as tr, splitTextFragments as ts, ProofKindCapability as tt, TurnStoppingDecision as u, GuardCheckpoint as ua, AuthorityBlockKind as ui, GIT_COMMAND_TEMPLATES as un, capabilityConsequence as uo, PROTOCOL_V6_NOTICE as ur, CERTIFICATE_VERSION_V2 as us, bindProofToProjection as ut, isRootPauseRequest as v, HostStatus as va, CONFIRM_LINE_PATTERN as vi, GitPrestateCheck as vn, ExecutionQualification as vo, ALPHA2_DSHMARKET_139_HOST_PACKAGES as vr, actionCompatible as vs, proofEvidenceConstraints as vt, testOutcomePredicate as w, TargetCaptureReasonCode as wa, certifyCheckpoint as wi, createGitPrestateEnvelope as wn, ScopeInterpretation as wo, ExecutableIdentity as wr, semanticActionFromCommand as ws, sessionQuery as wt, latestRootInstruction as x, NeedsReviewReason as xa, parseConfirmationMessage as xi, LinearCommitReadback as xn, LEGACY_QUALIFICATION as xo, BASE_HOST_PACKAGES as xr, requestedIdentityKey as xs, proofV2Rejection as xt, isWholeTaskCompletionClaim as y, MessageCoverage as ya, ParsedConfirmation as yi, GitPrestateEnvelope as yn, GRANTED_QUALIFICATION as yo, ALPHA2_HOST_PACKAGES as yr, boundedArtifactChoiceMatches as ys, proofHostSurfacesOf as yt, RecoveryOptions as z, BoundedSource as za, GoalActivationState as zi, hasCurrentCertificate as zn, isInformationalFragment as zo, HostPlatform as zr, FIRST_STEP_GUIDANCE as zt };