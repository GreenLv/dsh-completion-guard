...
async function tgzIdentity(path) {
	...
	const repository = typeof repositoryField === "string" ? repositoryField : record(repositoryField) && typeof record(repositoryField)?.url === "string" ? String(record(repositoryField).url) : void 0;
	return {
		name: manifest.name,
