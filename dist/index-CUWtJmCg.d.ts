...
//#endregion
export { ProofHostSurface as $, CapabilityGap as $a, DelegationRef as $i, Repairability as $n, questionHeadsClause as $o, HostVersionDecision as $r, auditedForegroundRenderers as $t, snapshotSessionEvents as A, TargetTuple as Aa, captureItem as Ai, revalidateGitPrestate as An, clauseIsGoverned as Ao, HOST_COHORTS as Ar, canonicalizePath as As, evidenceCoverage as At, carriesCleanupCondition as B, ReleaseSettlement as Ba, BoundaryRequest as Bi, goalCompletionDenial as Bn, isExplanationScope as Bo, HostLockStatus as Br, FirstStepInjection as Bt, progressFingerprint as C, NeedsReviewReason as Ca, parseConfirmationMessage as Ci, LinearCommitReadback as Cn, LEGACY_QUALIFICATION as Co, BASE_HOST_PACKAGES as Cr, requestedIdentityKey as Cs, scopeCoverageDigest as Ct, SESSION_EVENT_ENVELOPE_INVALID as D, TargetCaptureStatus as Da, CaptureScope as Di, executeRevalidatedGitEffect as Dn, actionVerbMatches as Do, ExecutableIdentityBinding as Dr, semanticActionFromText as Ds, validateProofManifestV2 as Dt, SESSION_API_UNSUPPORTED as E, TargetCaptureReasonCode as Ea, certifyCheckpoint as Ei, createGitPrestateEnvelope as En, ScopeInterpretation as Eo, ExecutableIdentity as Er, semanticActionFromCommand as Es, validateProofManifest as Et, CLEANUP_CONDITION_RULE_COMPACT as F, createProjection as Fa, extractOperation as Fi, ShellParseStatus as Fn, hasQuestionScope as Fo, HostCohort as Fr, sha256 as Fs, ManifestIssue as Ft, renderRecoveryPacket as G, confirmRebind as Ga, isCurrentAcceptedBoundary as Gi, evidenceFromPersistedToolResult as Gn, itemHoldsExecutionAuthority as Go, bindExecutableIdentity as Gr, firstStepGuidanceV6 as Gt, closingHint as H, ProposeOutcome as Ha, GoalBoundaryAccess as Hi, ToolCallInput as Hn, isOpenObligation as Ho, HostProfileKind as Hr, LifecyclePhase as Ht, CLEANUP_CONDITION_RULE_SHORT as I, PackageRow as Ia, isInformationalMessage as Ii, canonicalArgvFromCommand as In, interpretClause as Io, HostCohortSelection as Ir, OperationVerbEntry as It, PROOF_KINDS as J, proposeRebindV042 as Ja, AssetObligation as Ji, isDeterministicCheck as Jn, maskCodeSpans as Jo, evaluateHostCapability as Jr, ActiveProfileHostLock as Jt, ALPHA3_HOST_PACKAGES as K, proposeRebind as Ka, qualifyBoundary as Ki, extractTextContent as Kn, kindOfScope as Ko, bindLiveGoalCapability as Kr, lifecyclePhase as Kt, DEFAULT_RECOVERY_CHAR_BUDGET as L, ReleaseGateDecision as La, segmentClauses as Li, isRunExecutable as Ln, interpretMessage as Lo, HostCohortSelectionReason as Lr, validateManifest as Lt, RC015_HOST_PACKAGES as M, VerificationContract as Ma, environmentDefaultRepositoryTarget as Mi, CanonicalArgv as Mn, explanationHasActionResidue as Mo, HostCapabilityEvaluation as Mr, normalizeClause as Ms, isVerifyingCapability as Mt, RC1_HOST_PACKAGES as N, WaitAuthorization as Na, extractArtifactPaths as Ni, CanonicalCommandSurface as Nn, governedClauseRestrictsExecution as No, HostCapabilityId as Nr, sanitizeClauseText as Ns, COMMAND_SURFACE_MANIFEST as Nt, SessionApiError as O, TargetSource as Oa, ClauseSegment as Oi, gitCommandMatchesTarget as On, clarifiedSpanOf as Oo, GOAL_HOST_PACKAGES as Or, validateActionManifest as Os, EvidenceFacetCoverage as Ot, CLEANUP_CONDITION_RULE as P, WorkUnit as Pa, extractMethod as Pi, ParsedShell as Pn, hasOrderedCoordination as Po, HostCapabilityRequest as Pr, sanitizeUrl as Ps, CommandSurfaceManifest as Pt, PROOF_PROTOCOL_VERSION_V2 as Q, CapabilityFact as Qa, DeferAuthorization as Qi, DiagnosisNextAction as Qn, qualificationOfClause as Qo, selectHostCohort as Qr, auditedDefaultWorkdirProvider as Qt, MIN_RECOVERY_CHAR_BUDGET as R, ReleaseObservedIdentity as Ra, BoundaryEffectuation as Ri, parsePwshCommand as Rn, introducesActionClause as Ro, HostLockContext as Rr, ClaimedMessage as Rt, observeAssistantOutcome as S, NeedsReviewFact as Sa, isFrozenV042RebindResponse as Si, GitTargetIdentity as Sn, InterpretOptions as So, AuditedExecutable as Sr, isStatefulAction as Ss, requiredSubjectsOf as St, v6TestPredicate as T, SourceSpan as Ta, RejectedBinding as Ti, commitTreeSnapshotDigest as Tn, QualificationStatus as To, EXPECTED_HOST_PACKAGES as Tr, requestedTargetMatchesResolved as Ts, sessionQueryV2 as Tt, openItems as U, RebindArgs as Ua, availableBoundaryQualifications as Ui, ToolResultInput as Un, isQuestionScopeNeedingReview as Uo, HostToolSurface as Ur, claimedBatchHasRealRootInput as Ut, cleanupConditionFor as V, BoundedSource as Va, GoalActivationState as Vi, hasCurrentCertificate as Vn, isInformationalFragment as Vo, HostPlatform as Vr, FirstStepPreviewInput as Vt, recoveryDigest as W, RebindProposal as Wa, effectuateBoundary as Wi, ToolSubject as Wn, isRestatement as Wo, LEGACY_HOST_COHORTS as Wr, firstStepGuidance as Wt, PROOF_MANIFEST_DOMAIN_V2 as X, rebindResponse as Xa, BoundaryDisposition as Xi, withDurability as Xn, namedActions as Xo, evaluateToolSurfaceCapability as Xr, TargetHostGraph as Xt, PROOF_KINDS_V2 as Y, rebindAttemptKey as Ya, BindingActionClosure as Yi, persistedToolResultStatus as Yn, maskQuotedSpans as Yo, evaluateHostLock as Yr, HostProfileError as Yt, PROOF_PROTOCOL_VERSION as Z, replayRebindResult as Za, BoundaryQualificationKind as Zi, CertificationSupport as Zn, opensWithDirective as Zo, hostVersionFromPackages as Zr, auditedDefaultWorkdirHost as Zt, decisionBoundaryKey as _, GuardItemStatus as _a, UserInteractionKind as _i, GitCommandRejected as _n, AuthorityDisposition as _o, ACTIVE_HOST_COHORT_ID as _r, SUPPORTED_EVIDENCE_ADAPTERS as _s, proofDigestV2 as _t, CONTROL_RECORD_PREFIX as a, EvidenceOutcome as aa, SUPPORTED_HOST_VERSIONS as ai, packageRowsFromActiveGraph as an, OperationAttribution as ao, itemDiagnosis as ar, verbIsNegated as as, ProofObligation as at, latestAssistantText as b, HostStatus as ba, CONFIRM_LINE_PATTERN as bi, GitPrestateCheck as bn, ExecutionQualification as bo, ALPHA2_DSHMARKET_139_HOST_PACKAGES as br, actionCompatible as bs, proofOperationMatches as bt, NO_PROGRESS_RECORD_PREFIX as c, ExpectedTransition as ca, parseHostVersion as ci, resolveActiveProfileHostLock as cn, ProcessOutcomeReason as co, DEFAULT_DELEGATION_TOOL_NAMES as cr, ActionManifest as cs, SessionQuery as ct, assessmentAction as d, GuardBoundary as da, AuthorityBlock as di, GIT_COMMAND_MANIFEST_IDS as dn, admissibleForRemoval as do, PROTOCOL_V5_NOTICE as dr, CERTIFICATE_VERSION as ds, bindProofV2ToProjection as dt, DeriveConfig as ea, HostVersionStatus as ei, combineHostPolicy as en, CapabilityRemedy as eo, TaskKind as er, reportingHeadGoverns as es, ProofKind as et, assessmentOutcomePredicate as f, GuardCheckpoint as fa, AuthorityBlockKind as fi, GIT_COMMAND_TEMPLATES as fn, capabilityConsequence as fo, PROTOCOL_V6_NOTICE as fr, CERTIFICATE_VERSION_V2 as fs, canonicalProjection as ft, decideTurnStopping as g, GuardItemKind as ga, TaskIntent as gi, GitCommandParseResult as gn, removalIsPartiallyKnown as go, rootLocatorFlavor as gr, STOP_PROTOCOL_VERSION_V2 as gs, proofDigest as gt, decideTurnBoundary as h, GuardItem as ha, segmentAuthorityBlocks as hi, GitCommandManifest as hn, removalIsComplete as ho, legacyRecordsNeedingReview as hr, STOP_PROTOCOL_VERSION as hs, proofCapabilityReport as ht, AssistantOutcomeObservation as i, EvidenceBinding as ia, SUPPORTED_HOST_RANGE as ii, inspectTargetHostGraph as in, DerivedProcessFacts as io, evidenceAvailabilityReason as ir, statefulActionsOfScope as is, ProofManifestV2 as it, RC015_RC2_HOST_PACKAGES as j, TargetValue as ja, classifyClause as ji, verifiedLinearCommitReadback as jn, clauseIsProtected as jo, HostAuditProvenance as jr, digestStrings as js, evidenceMatchesItem as jt, V3SessionLike as k, TargetSourceKind as ka, captureClause as ki, parseGitCommandManifest as kn, clauseAsksOwnQuestion as ko, HOST_CAPABILITY_PACKAGE_GROUPS as kr, validateActionTarget as ks, bindingSatisfies as kt, NO_PROGRESS_TURNS_BEFORE_STOP as l, ExternalOperation as la, satisfiesSupportedHostRange as li, resolveInstalledHostLock as ln, RemovalOutcomeReport as lo, PROTOCOL_V3_NOTICE as lr, ActionSpec as ls, SessionQueryV2 as lt, currentActionBases as m, GuardIntegrity as ma, authorityCaptureCounts as mi, GitCommandAccepted as mn, partialFailureOf as mo, deriveProjection as mr, STATEFUL_ACTIONS as ms, createProofManifestV2 as mt, projectCoreV2 as n, DeriveScope as na, MIN_SUPPORTED_HOST_VERSION as ni, hostLockRowsFromComposedDump as nn, DeclaredOperationResult as no, capabilityRemedyPhrase as nr, semanticActionOfScope as ns, ProofKindV2 as nt, CompletionDisposition as o, EvidenceParseStatus as oa, compareHostVersions as oi, packageRowsFromPnpmLock as on, ProcessExitStatus as oo, relevantEvidence as or, ACTION_MANIFEST as os, ProofObligationV2 as ot, classifyCompletionClaim as p, GuardEvidence as pa, AuthorityKind as pi, GitAdapterAction as pn, capabilityFactOf as po, applyUpgradeEligibility as pr, SEMANTIC_ACTIONS as ps, createProofManifest as pt, PROOF_CAPABILITY_MATRIX as q, proposeRebindOutcome as qa, AssetInterpretationFact as qi, extractToolSubject as qn, legacyQuestionReadingIsInformational as qo, evaluateExternalWaitCapability as qr, previewFirstStepInjection as qt, supersedeItem as r, DerivedEnvelope as ra, ParsedHostVersion as ri, injectActiveProfileHostLock as rn, DependencyStatus as ro, deriveItemDiagnosis as rr, splitTextFragments as rs, ProofManifest as rt, CurrentActionBasis as s, EvidenceRole as sa, evaluateMinimumHostVersion as si, readActiveHostGraph as sn, ProcessFactSource as so, CAPTURE_V042_NOTICE as sr, ACTION_MANIFEST_VERSION as ss, ProofSurface as st, projectSessionCoreV2 as t, DeriveResult as ta, LATEST_SUPPORTED_HOST_VERSION as ti, hostLockContextFromComposedDump as tn, DEPENDENCY_FREE_ONLY_CONDITION as to, UnifiedItemDiagnosis as tr, restatedContentOf as ts, ProofKindCapability as tt, TurnStoppingDecision as u, GoalRef as ua, currentContractDigest as ui, verifyComposedHostLockDump as un, actionHasCertificationPath as uo, PROTOCOL_V4_NOTICE as ur, BOUNDED_ARTIFACT_TYPES as us, bindProofToProjection as ut, isRootPauseRequest as v, GuardOperation as va, classifyTaskIntent as vi, GitEffectExecution as vn, DirectiveClass as vo, ACTIVE_HOST_COHORT_IDS as vr, SemanticAction as vs, proofEvidenceConstraints as vt, testOutcomePredicate as w, PersistenceAuthorization as wa, CheckpointResult as wi, commitIndexSnapshotDigest as wn, QualificationReason as wo, DEFAULT_HOST_LOCK as wr, requestedTargetAuthorizesMutation as ws, sessionQuery as wt, latestRootInstruction as x, MessageCoverage as xa, ParsedConfirmation as xi, GitPrestateEnvelope as xn, GRANTED_QUALIFICATION as xo, ALPHA2_HOST_PACKAGES as xr, boundedArtifactChoiceMatches as xs, proofV2Rejection as xt, isWholeTaskCompletionClaim as y, GuardProjection as ya, classifyUserInteraction as yi, GitEffectRunner as yn, Executee as yo, ACTIVE_HOST_LAUNCHER_VERSION as yr, StatefulAction as ys, proofHostSurfacesOf as yt, RecoveryOptions as z, ReleaseOperation as za, BoundaryQualification as zi, parseShellCommand as zn, isExecutableItem as zo, HostLockEvaluation as zr, FIRST_STEP_GUIDANCE as zt };