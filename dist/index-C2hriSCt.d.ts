...
//#endregion
export { ProofKind as $, DependencyStatus as $a, DerivedEnvelope as $i, deriveItemDiagnosis as $n, splitTextFragments as $o, ParsedHostVersion as $r, injectActiveProfileHostLock as $t, RC015_RC2_HOST_PACKAGES as A, WorkUnit as Aa, extractMethod as Ai, ParsedShell as An, hasOrderedCoordination as Ao, HostCapabilityRequest as Ar, sanitizeUrl as As, evidenceMatchesItem as At, cleanupConditionFor as B, RebindProposal as Ba, effectuateBoundary as Bi, ToolSubject as Bn, isRestatement as Bo, LEGACY_HOST_COHORTS as Br, FirstStepPreviewInput as Bt, progressFingerprint as C, TargetCaptureStatus as Ca, CaptureScope as Ci, executeRevalidatedGitEffect as Cn, actionVerbMatches as Co, ExecutableIdentityBinding as Cr, semanticActionFromText as Cs, sessionQuery as Ct, SessionApiError as D, TargetValue as Da, classifyClause as Di, verifiedLinearCommitReadback as Dn, clauseIsProtected as Do, HostAuditProvenance as Dr, digestStrings as Ds, EvidenceFacetCoverage as Dt, SESSION_EVENT_ENVELOPE_INVALID as E, TargetTuple as Ea, captureItem as Ei, revalidateGitPrestate as En, clauseIsGoverned as Eo, HOST_COHORTS as Er, canonicalizePath as Es, validateProofManifestV2 as Et, CLEANUP_CONDITION_RULE_SHORT as F, ReleaseOperation as Fa, BoundaryQualification as Fi, parseShellCommand as Fn, isExecutableItem as Fo, HostLockEvaluation as Fr, OperationVerbEntry as Ft, ALPHA3_HOST_PACKAGES as G, rebindAttemptKey as Ga, BindingActionClosure as Gi, persistedToolResultStatus as Gn, maskQuotedSpans as Go, evaluateHostLock as Gr, lifecyclePhase as Gt, openItems as H, proposeRebind as Ha, qualifyBoundary as Hi, extractTextContent as Hn, kindOfScope as Ho, bindLiveGoalCapability as Hr, claimedBatchHasRealRootInput as Ht, DEFAULT_RECOVERY_CHAR_BUDGET as I, ReleaseSettlement as Ia, BoundaryRequest as Ii, goalCompletionDenial as In, isExplanationScope as Io, HostLockStatus as Ir, validateManifest as It, PROOF_KINDS_V2 as J, CapabilityFact as Ja, DeferAuthorization as Ji, DiagnosisNextAction as Jn, qualificationOfClause as Jo, selectHostCohort as Jr, HostProfileError as Jt, PROOF_CAPABILITY_MATRIX as K, rebindResponse as Ka, BoundaryDisposition as Ki, withDurability as Kn, namedActions as Ko, evaluateToolSurfaceCapability as Kr, previewFirstStepInjection as Kt, MIN_RECOVERY_CHAR_BUDGET as L, BoundedSource as La, GoalActivationState as Li, hasCurrentCertificate as Ln, isInformationalFragment as Lo, HostPlatform as Lr, ClaimedMessage as Lt, RC1_HOST_PACKAGES as M, PackageRow as Ma, isInformationalMessage as Mi, canonicalArgvFromCommand as Mn, interpretClause as Mo, HostCohortSelection as Mr, COMMAND_SURFACE_MANIFEST as Mt, CLEANUP_CONDITION_RULE as N, ReleaseGateDecision as Na, segmentClauses as Ni, isRunExecutable as Nn, interpretMessage as No, HostCohortSelectionReason as Nr, CommandSurfaceManifest as Nt, V3SessionLike as O, VerificationContract as Oa, environmentDefaultRepositoryTarget as Oi, CanonicalArgv as On, explanationHasActionResidue as Oo, HostCapabilityEvaluation as Or, normalizeClause as Os, bindingSatisfies as Ot, CLEANUP_CONDITION_RULE_COMPACT as P, ReleaseObservedIdentity as Pa, BoundaryEffectuation as Pi, parsePwshCommand as Pn, introducesActionClause as Po, HostLockContext as Pr, ManifestIssue as Pt, ProofHostSurface as Q, DeclaredOperationResult as Qa, DeriveScope as Qi, capabilityRemedyPhrase as Qn, semanticActionOfScope as Qo, MIN_SUPPORTED_HOST_VERSION as Qr, hostLockRowsFromComposedDump as Qt, RecoveryOptions as R, ProposeOutcome as Ra, GoalBoundaryAccess as Ri, ToolCallInput as Rn, isOpenObligation as Ro, HostProfileKind as Rr, FIRST_STEP_GUIDANCE as Rt, observeAssistantOutcome as S, TargetCaptureReasonCode as Sa, certifyCheckpoint as Si, createGitPrestateEnvelope as Sn, ScopeInterpretation as So, ExecutableIdentity as Sr, semanticActionFromCommand as Ss, scopeCoverageDigest as St, SESSION_API_UNSUPPORTED as T, TargetSourceKind as Ta, captureClause as Ti, parseGitCommandManifest as Tn, clauseAsksOwnQuestion as To, HOST_CAPABILITY_PACKAGE_GROUPS as Tr, validateActionTarget as Ts, validateProofManifest as Tt, recoveryDigest as U, proposeRebindOutcome as Ua, AssetInterpretationFact as Ui, extractToolSubject as Un, legacyQuestionReadingIsInformational as Uo, evaluateExternalWaitCapability as Ur, firstStepGuidance as Ut, closingHint as V, confirmRebind as Va, isCurrentAcceptedBoundary as Vi, evidenceFromPersistedToolResult as Vn, itemHoldsExecutionAuthority as Vo, bindExecutableIdentity as Vr, LifecyclePhase as Vt, renderRecoveryPacket as W, proposeRebindV042 as Wa, AssetObligation as Wi, isDeterministicCheck as Wn, maskCodeSpans as Wo, evaluateHostCapability as Wr, firstStepGuidanceV6 as Wt, PROOF_PROTOCOL_VERSION as X, CapabilityRemedy as Xa, DeriveConfig as Xi, TaskKind as Xn, reportingHeadGoverns as Xo, HostVersionStatus as Xr, combineHostPolicy as Xt, PROOF_MANIFEST_DOMAIN_V2 as Y, CapabilityGap as Ya, DelegationRef as Yi, Repairability as Yn, questionHeadsClause as Yo, HostVersionDecision as Yr, TargetHostGraph as Yt, PROOF_PROTOCOL_VERSION_V2 as Z, DEPENDENCY_FREE_ONLY_CONDITION as Za, DeriveResult as Zi, UnifiedItemDiagnosis as Zn, restatedContentOf as Zo, LATEST_SUPPORTED_HOST_VERSION as Zr, hostLockContextFromComposedDump as Zt, decisionBoundaryKey as _, MessageCoverage as _a, ParsedConfirmation as _i, GitPrestateEnvelope as _n, GRANTED_QUALIFICATION as _o, ALPHA2_HOST_PACKAGES as _r, boundedArtifactChoiceMatches as _s, proofEvidenceConstraints as _t, CONTROL_RECORD_PREFIX as a, ExternalOperation as aa, satisfiesSupportedHostRange as ai, resolveInstalledHostLock as an, RemovalOutcomeReport as ao, PROTOCOL_V3_NOTICE as ar, ActionSpec as as, ProofObligationV2 as at, latestAssistantText as b, PersistenceAuthorization as ba, CheckpointResult as bi, commitIndexSnapshotDigest as bn, QualificationReason as bo, DEFAULT_HOST_LOCK as br, requestedTargetAuthorizesMutation as bs, proofV2Rejection as bt, NO_PROGRESS_RECORD_PREFIX as c, GuardCheckpoint as ca, AuthorityBlockKind as ci, GIT_COMMAND_TEMPLATES as cn, capabilityConsequence as co, PROTOCOL_V6_NOTICE as cr, CERTIFICATE_VERSION_V2 as cs, SessionQueryV2 as ct, assessmentAction as d, GuardItem as da, segmentAuthorityBlocks as di, GitCommandManifest as dn, removalIsComplete as do, legacyRecordsNeedingReview as dr, STOP_PROTOCOL_VERSION as ds, canonicalProjection as dt, EvidenceBinding as ea, SUPPORTED_HOST_RANGE as ei, inspectTargetHostGraph as en, DerivedProcessFacts as eo, evidenceAvailabilityReason as er, statefulActionsOfScope as es, ProofKindCapability as et, assessmentOutcomePredicate as f, GuardItemKind as fa, TaskIntent as fi, GitCommandParseResult as fn, removalIsPartiallyKnown as fo, rootLocatorFlavor as fr, STOP_PROTOCOL_VERSION_V2 as fs, createProofManifest as ft, decideTurnStopping as g, HostStatus as ga, CONFIRM_LINE_PATTERN as gi, GitPrestateCheck as gn, ExecutionQualification as go, ALPHA2_DSHMARKET_139_HOST_PACKAGES as gr, actionCompatible as gs, proofDigestV2 as gt, decideTurnBoundary as h, GuardProjection as ha, classifyUserInteraction as hi, GitEffectRunner as hn, Executee as ho, ACTIVE_HOST_LAUNCHER_VERSION as hr, StatefulAction as hs, proofDigest as ht, AssistantOutcomeObservation as i, ExpectedTransition as ia, parseHostVersion as ii, resolveActiveProfileHostLock as in, ProcessOutcomeReason as io, DEFAULT_DELEGATION_TOOL_NAMES as ir, ActionManifest as is, ProofObligation as it, RC015_HOST_PACKAGES as j, createProjection as ja, extractOperation as ji, ShellParseStatus as jn, hasQuestionScope as jo, HostCohort as jr, sha256 as js, isVerifyingCapability as jt, snapshotSessionEvents as k, WaitAuthorization as ka, extractArtifactPaths as ki, CanonicalCommandSurface as kn, governedClauseRestrictsExecution as ko, HostCapabilityId as kr, sanitizeClauseText as ks, evidenceCoverage as kt, NO_PROGRESS_TURNS_BEFORE_STOP as l, GuardEvidence as la, AuthorityKind as li, GitAdapterAction as ln, capabilityFactOf as lo, applyUpgradeEligibility as lr, SEMANTIC_ACTIONS as ls, bindProofToProjection as lt, currentActionBases as m, GuardOperation as ma, classifyTaskIntent as mi, GitEffectExecution as mn, DirectiveClass as mo, ACTIVE_HOST_COHORT_IDS as mr, SemanticAction as ms, proofCapabilityReport as mt, projectCoreV2 as n, EvidenceParseStatus as na, compareHostVersions as ni, packageRowsFromPnpmLock as nn, ProcessExitStatus as no, relevantEvidence as nr, ACTION_MANIFEST as ns, ProofManifest as nt, CompletionDisposition as o, GoalRef as oa, currentContractDigest as oi, verifyComposedHostLockDump as on, actionHasCertificationPath as oo, PROTOCOL_V4_NOTICE as or, BOUNDED_ARTIFACT_TYPES as os, ProofSurface as ot, classifyCompletionClaim as p, GuardItemStatus as pa, UserInteractionKind as pi, GitCommandRejected as pn, AuthorityDisposition as po, ACTIVE_HOST_COHORT_ID as pr, SUPPORTED_EVIDENCE_ADAPTERS as ps, createProofManifestV2 as pt, PROOF_KINDS as q, replayRebindResult as qa, BoundaryQualificationKind as qi, CertificationSupport as qn, opensWithDirective as qo, hostVersionFromPackages as qr, ActiveProfileHostLock as qt, supersedeItem as r, EvidenceRole as ra, evaluateMinimumHostVersion as ri, readActiveHostGraph as rn, ProcessFactSource as ro, CAPTURE_V042_NOTICE as rr, ACTION_MANIFEST_VERSION as rs, ProofManifestV2 as rt, CurrentActionBasis as s, GuardBoundary as sa, AuthorityBlock as si, GIT_COMMAND_MANIFEST_IDS as sn, admissibleForRemoval as so, PROTOCOL_V5_NOTICE as sr, CERTIFICATE_VERSION as ss, SessionQuery as st, projectSessionCoreV2 as t, EvidenceOutcome as ta, SUPPORTED_HOST_VERSIONS as ti, packageRowsFromActiveGraph as tn, OperationAttribution as to, itemDiagnosis as tr, verbIsNegated as ts, ProofKindV2 as tt, TurnStoppingDecision as u, GuardIntegrity as ua, authorityCaptureCounts as ui, GitCommandAccepted as un, partialFailureOf as uo, deriveProjection as ur, STATEFUL_ACTIONS as us, bindProofV2ToProjection as ut, isRootPauseRequest as v, NeedsReviewFact as va, isFrozenV042RebindResponse as vi, GitTargetIdentity as vn, InterpretOptions as vo, AuditedExecutable as vr, isStatefulAction as vs, proofHostSurfacesOf as vt, testOutcomePredicate as w, TargetSource as wa, ClauseSegment as wi, gitCommandMatchesTarget as wn, clarifiedSpanOf as wo, GOAL_HOST_PACKAGES as wr, validateActionManifest as ws, sessionQueryV2 as wt, latestRootInstruction as x, SourceSpan as xa, RejectedBinding as xi, commitTreeSnapshotDigest as xn, QualificationStatus as xo, EXPECTED_HOST_PACKAGES as xr, requestedTargetMatchesResolved as xs, requiredSubjectsOf as xt, isWholeTaskCompletionClaim as y, NeedsReviewReason as ya, parseConfirmationMessage as yi, LinearCommitReadback as yn, LEGACY_QUALIFICATION as yo, BASE_HOST_PACKAGES as yr, requestedIdentityKey as ys, proofOperationMatches as yt, carriesCleanupCondition as z, RebindArgs as za, availableBoundaryQualifications as zi, ToolResultInput as zn, isQuestionScopeNeedingReview as zo, HostToolSurface as zr, FirstStepInjection as zt };