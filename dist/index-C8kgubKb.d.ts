...
//#endregion
export { resolveActiveProfileHostLock as $, DeferAuthorization as $n, sanitizeUrl as $r, HOST_COHORTS as $t, createProofManifest as A, certifyCheckpoint as An, ACTION_MANIFEST as Ar, goalCompletionDenial as At, COMMAND_SURFACE_MANIFEST as B, isInformationalMessage as Bn, StatefulAction as Br, CAPTURE_V042_NOTICE as Bt, ProofKind as C, AuthorityKind as Cn, TargetCaptureStatus as Cr, CanonicalCommandSurface as Ct, SessionQuery as D, classifyUserInteraction as Dn, WaitAuthorization as Dr, isRunExecutable as Dt, ProofSurface as E, UserInteractionKind as En, VerificationContract as Er, canonicalArgvFromCommand as Et, EvidenceFacetCoverage as F, captureItem as Fn, SEMANTIC_ACTIONS as Fr, evidenceFromPersistedToolResult as Ft, ActiveProfileHostLock as G, GoalActivationState as Gn, semanticActionFromCommand as Gr, AuditedExecutable as Gt, ManifestIssue as H, BoundaryEffectuation as Hn, isStatefulAction as Hr, deriveProjection as Ht, bindingSatisfies as I, classifyClause as In, STATEFUL_ACTIONS as Ir, extractTextContent as It, hostLockRowsFromComposedDump as J, effectuateBoundary as Jn, validateActionTarget as Jr, EXPECTED_HOST_PACKAGES as Jt, HostProfileError as K, GoalBoundaryAccess as Kn, semanticActionFromText as Kr, BASE_HOST_PACKAGES as Kt, evidenceCoverage as L, extractArtifactPaths as Ln, STOP_PROTOCOL_VERSION as Lr, extractToolSubject as Lt, proofEvidenceConstraints as M, ClassifiedClause as Mn, ActionManifest as Mr, ToolCallInput as Mt, sessionQuery as N, ClauseSegment as Nn, ActionSpec as Nr, ToolResultInput as Nt, bindProofToProjection as O, CheckpointResult as On, createProjection as Or, parsePwshCommand as Ot, validateProofManifest as P, captureClause as Pn, CERTIFICATE_VERSION as Pr, ToolSubject as Pt, readActiveHostGraph as Q, BoundaryQualificationKind as Qn, sanitizeClauseText as Qr, HOST_CAPABILITY_PACKAGE_GROUPS as Qt, evidenceMatchesItem as R, extractMethod as Rn, SUPPORTED_EVIDENCE_ADAPTERS as Rr, isDeterministicCheck as Rt, PROOF_PROTOCOL_VERSION as S, AuthorityBlockKind as Sn, TargetCaptureReasonCode as Sr, CanonicalArgv as St, ProofObligation as T, segmentAuthorityBlocks as Tn, TargetValue as Tr, ShellParseStatus as Tt, OperationVerbEntry as U, BoundaryQualification as Un, requestedTargetAuthorizesMutation as Ur, ALPHA2_DSHMARKET_139_HOST_PACKAGES as Ut, CommandSurfaceManifest as V, segmentClauses as Vn, actionCompatible as Vr, PROTOCOL_V3_NOTICE as Vt, validateManifest as W, BoundaryRequest as Wn, requestedTargetMatchesResolved as Wr, ALPHA2_HOST_PACKAGES as Wt, packageRowsFromActiveGraph as X, qualifyBoundary as Xn, digestStrings as Xr, ExecutableIdentityBinding as Xt, injectActiveProfileHostLock as Y, isCurrentAcceptedBoundary as Yn, canonicalizePath as Yr, ExecutableIdentity as Yt, packageRowsFromPnpmLock as Z, BoundaryDisposition as Zn, normalizeClause as Zr, GOAL_HOST_PACKAGES as Zt, openItems as _, evaluateHostLock as _n, GuardItemStatus as _r, executeRevalidatedGitEffect as _t, classifyCompletionClaim as a, HostCohortSelectionReason as an, EvidenceOutcome as ar, GitCommandManifest as at, ALPHA3_HOST_PACKAGES as b, currentContractDigest as bn, HostStatus as br, revalidateGitPrestate as bt, isWholeTaskCompletionClaim as c, HostLockStatus as cn, ExpectedTransition as cr, GitEffectExecution as ct, snapshotSessionEvents as d, HostToolSurface as dn, GuardBoundary as dr, GitPrestateEnvelope as dt, sha256 as ei, HostCapabilityEvaluation as en, DeriveConfig as er, resolveInstalledHostLock as et, RC1_HOST_PACKAGES as f, LEGACY_HOST_COHORTS as fn, GuardCheckpoint as fr, GitTargetIdentity as ft, closingHint as g, evaluateHostCapability as gn, GuardItemKind as gr, createGitPrestateEnvelope as gt, RecoveryOptions as h, evaluateExternalWaitCapability as hn, GuardItem as hr, commitTreeSnapshotDigest as ht, TurnStoppingDecision as i, HostCohortSelection as in, EvidenceBinding as ir, GitCommandAccepted as it, proofDigest as j, CaptureScope as jn, ACTION_MANIFEST_VERSION as jr, hasCurrentCertificate as jt, canonicalProjection as k, RejectedBinding as kn, PackageRow as kr, parseShellCommand as kt, latestAssistantText as l, HostPlatform as ln, ExternalOperation as lr, GitEffectRunner as lt, MIN_RECOVERY_CHAR_BUDGET as m, bindLiveGoalCapability as mn, GuardIntegrity as mr, commitIndexSnapshotDigest as mt, AssistantOutcomeObservation as n, HostCapabilityRequest as nn, DeriveScope as nr, GIT_COMMAND_MANIFEST_IDS as nt, decideTurnBoundary as o, HostLockContext as on, EvidenceParseStatus as or, GitCommandParseResult as ot, DEFAULT_RECOVERY_CHAR_BUDGET as p, bindExecutableIdentity as pn, GuardEvidence as pr, LinearCommitReadback as pt, hostLockContextFromComposedDump as q, availableBoundaryQualifications as qn, validateActionManifest as qr, DEFAULT_HOST_LOCK as qt, CompletionDisposition as r, HostCohort as rn, DerivedEnvelope as rr, GitAdapterAction as rt, decideTurnStopping as s, HostLockEvaluation as sn, EvidenceRole as sr, GitCommandRejected as st, supersedeItem as t, HostCapabilityId as tn, DeriveResult as tr, verifyComposedHostLockDump as tt, observeAssistantOutcome as u, HostProfileKind as un, GoalRef as ur, GitPrestateCheck as ut, recoveryDigest as v, evaluateToolSurfaceCapability as vn, GuardOperation as vr, gitCommandMatchesTarget as vt, ProofManifest as w, authorityCaptureCounts as wn, TargetTuple as wr, ParsedShell as wt, PROOF_KINDS as x, AuthorityBlock as xn, PersistenceAuthorization as xr, verifiedLinearCommitReadback as xt, renderRecoveryPacket as y, selectHostCohort as yn, GuardProjection as yr, parseGitCommandManifest as yt, isVerifyingCapability as z, extractOperation as zn, SemanticAction as zr, withDurability as zt };