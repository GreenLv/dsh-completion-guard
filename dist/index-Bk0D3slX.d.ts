...
//#endregion
export { CommandSurfaceManifest as $, statefulActionsOfScope as $i, evaluateHostCapability as $n, DeriveConfig as $r, parseShellCommand as $t, recoveryDigest as A, ProposeOutcome as Ai, EXPECTED_HOST_PACKAGES as An, CaptureScope as Ar, GitCommandParseResult as At, bindProofToProjection as B, AuthorityDisposition as Bi, HostCohort as Bn, BoundaryEffectuation as Br, createGitPrestateEnvelope as Bt, RC015_HOST_PACKAGES as C, sanitizeUrl as Ca, TargetTuple as Ci, ACTIVE_HOST_COHORT_ID as Cn, CONFIRM_LINE_PATTERN as Cr, resolveInstalledHostLock as Ct, RecoveryOptions as D, createProjection as Di, AuditedExecutable as Dn, CheckpointResult as Dr, GitAdapterAction as Dt, MIN_RECOVERY_CHAR_BUDGET as E, WaitAuthorization as Ei, ALPHA2_HOST_PACKAGES as En, parseConfirmationMessage as Er, GIT_COMMAND_TEMPLATES as Et, ProofKind as F, proposeRebindOutcome as Fi, HOST_COHORTS as Fn, extractArtifactPaths as Fr, GitPrestateEnvelope as Ft, sessionQuery as G, interpretClause as Gi, HostLockStatus as Gn, availableBoundaryQualifications as Gr, verifiedLinearCommitReadback as Gt, createProofManifest as H, Executee as Hi, HostCohortSelectionReason as Hn, BoundaryRequest as Hr, gitCommandMatchesTarget as Ht, ProofManifest as I, proposeRebindV042 as Ii, HostAuditProvenance as In, extractMethod as Ir, GitTargetIdentity as It, bindingSatisfies as J, isOpenObligation as Ji, HostToolSurface as Jn, qualifyBoundary as Jr, ParsedShell as Jt, validateProofManifest as K, interpretMessage as Ki, HostPlatform as Kn, effectuateBoundary as Kr, CanonicalArgv as Kt, ProofObligation as L, rebindAttemptKey as Li, HostCapabilityEvaluation as Ln, extractOperation as Lr, LinearCommitReadback as Lt, ALPHA3_HOST_PACKAGES as M, RebindProposal as Mi, ExecutableIdentityBinding as Mn, captureClause as Mr, GitEffectExecution as Mt, PROOF_KINDS as N, confirmRebind as Ni, GOAL_HOST_PACKAGES as Nn, captureItem as Nr, GitEffectRunner as Nt, closingHint as O, PackageRow as Oi, BASE_HOST_PACKAGES as On, RejectedBinding as Or, GitCommandAccepted as Ot, PROOF_PROTOCOL_VERSION as P, proposeRebind as Pi, HOST_CAPABILITY_PACKAGE_GROUPS as Pn, classifyClause as Pr, GitPrestateCheck as Pt, COMMAND_SURFACE_MANIFEST as Q, semanticActionOfScope as Qi, evaluateExternalWaitCapability as Qn, DeferAuthorization as Qr, parsePwshCommand as Qt, ProofSurface as R, rebindResponse as Ri, HostCapabilityId as Rn, isInformationalMessage as Rr, commitIndexSnapshotDigest as Rt, snapshotSessionEvents as S, sanitizeClauseText as Sa, TargetCaptureStatus as Si, deriveProjection as Sn, classifyUserInteraction as Sr, resolveActiveProfileHostLock as St, DEFAULT_RECOVERY_CHAR_BUDGET as T, VerificationContract as Ti, ALPHA2_DSHMARKET_139_HOST_PACKAGES as Tn, isFrozenV042RebindResponse as Tr, GIT_COMMAND_MANIFEST_IDS as Tt, proofDigest as U, InterpretOptions as Ui, HostLockContext as Un, GoalActivationState as Ur, parseGitCommandManifest as Ut, canonicalProjection as V, DirectiveClass as Vi, HostCohortSelection as Vn, BoundaryQualification as Vr, executeRevalidatedGitEffect as Vt, proofEvidenceConstraints as W, ScopeInterpretation as Wi, HostLockEvaluation as Wn, GoalBoundaryAccess as Wr, revalidateGitPrestate as Wt, evidenceMatchesItem as X, maskCodeSpans as Xi, bindExecutableIdentity as Xn, BoundaryDisposition as Xr, canonicalArgvFromCommand as Xt, evidenceCoverage as Y, kindOfScope as Yi, LEGACY_HOST_COHORTS as Yn, BindingActionClosure as Yr, ShellParseStatus as Yt, isVerifyingCapability as Z, namedActions as Zi, bindLiveGoalCapability as Zn, BoundaryQualificationKind as Zr, isRunExecutable as Zt, progressFingerprint as _, validateActionManifest as _a, GuardOperation as _i, itemDiagnosis as _n, authorityCaptureCounts as _r, injectActiveProfileHostLock as _t, NO_PROGRESS_RECORD_PREFIX as a, SEMANTIC_ACTIONS as aa, EvidenceParseStatus as ai, evidenceFromPersistedToolResult as an, HostVersionStatus as ar, FirstStepInjection as at, SessionApiError as b, digestStrings as ba, PersistenceAuthorization as bi, PROTOCOL_V3_NOTICE as bn, UserInteractionKind as br, packageRowsFromPnpmLock as bt, classifyCompletionClaim as c, SUPPORTED_EVIDENCE_ADAPTERS as ca, ExternalOperation as ci, isDeterministicCheck as cn, SUPPORTED_HOST_RANGE as cr, claimedBatchHasRealRootInput as ct, decisionBoundaryKey as d, actionCompatible as da, GuardCheckpoint as di, DiagnosisNextAction as dn, parseHostVersion as dr, ActiveProfileHostLock as dt, ACTION_MANIFEST as ea, DeriveResult as ei, goalCompletionDenial as en, evaluateHostLock as er, ManifestIssue as et, isRootPauseRequest as f, isStatefulAction as fa, GuardEvidence as fi, Repairability as fn, satisfiesSupportedHostRange as fr, HostProfileError as ft, observeAssistantOutcome as g, semanticActionFromText as ga, GuardItemStatus as gi, evidenceAvailabilityReason as gn, AuthorityKind as gr, hostLockRowsFromComposedDump as gt, latestRootInstruction as h, semanticActionFromCommand as ha, GuardItemKind as hi, deriveItemDiagnosis as hn, AuthorityBlockKind as hr, hostLockContextFromComposedDump as ht, CompletionDisposition as i, CERTIFICATE_VERSION as ia, EvidenceOutcome as ii, ToolSubject as in, HostVersionDecision as ir, FIRST_STEP_GUIDANCE as it, renderRecoveryPacket as j, RebindArgs as ji, ExecutableIdentity as jn, ClauseSegment as jr, GitCommandRejected as jt, openItems as k, BoundedSource as ki, DEFAULT_HOST_LOCK as kn, certifyCheckpoint as kr, GitCommandManifest as kt, decideTurnBoundary as l, SemanticAction as la, GoalRef as li, withDurability as ln, compareHostVersions as lr, lifecyclePhase as lt, latestAssistantText as m, requestedTargetMatchesResolved as ma, GuardItem as mi, UnifiedItemDiagnosis as mn, AuthorityBlock as mr, combineHostPolicy as mt, AssistantOutcomeObservation as n, ActionManifest as na, DerivedEnvelope as ni, ToolCallInput as nn, hostVersionFromPackages as nr, validateManifest as nt, NO_PROGRESS_TURNS_BEFORE_STOP as o, STATEFUL_ACTIONS as oa, EvidenceRole as oi, extractTextContent as on, MIN_SUPPORTED_HOST_VERSION as or, FirstStepPreviewInput as ot, isWholeTaskCompletionClaim as p, requestedTargetAuthorizesMutation as pa, GuardIntegrity as pi, TaskKind as pn, currentContractDigest as pr, TargetHostGraph as pt, EvidenceFacetCoverage as q, isExecutableItem as qi, HostProfileKind as qn, isCurrentAcceptedBoundary as qr, CanonicalCommandSurface as qt, CONTROL_RECORD_PREFIX as r, ActionSpec as ra, EvidenceBinding as ri, ToolResultInput as rn, selectHostCohort as rr, ClaimedMessage as rt, TurnStoppingDecision as s, STOP_PROTOCOL_VERSION as sa, ExpectedTransition as si, extractToolSubject as sn, ParsedHostVersion as sr, LifecyclePhase as st, supersedeItem as t, ACTION_MANIFEST_VERSION as ta, DeriveScope as ti, hasCurrentCertificate as tn, evaluateToolSurfaceCapability as tr, OperationVerbEntry as tt, decideTurnStopping as u, StatefulAction as ua, GuardBoundary as ui, CertificationSupport as un, evaluateMinimumHostVersion as ur, previewFirstStepInjection as ut, SESSION_API_UNSUPPORTED as v, validateActionTarget as va, GuardProjection as vi, relevantEvidence as vn, segmentAuthorityBlocks as vr, inspectTargetHostGraph as vt, RC1_HOST_PACKAGES as w, sha256 as wa, TargetValue as wi, ACTIVE_HOST_LAUNCHER_VERSION as wn, ParsedConfirmation as wr, verifyComposedHostLockDump as wt, V3SessionLike as x, normalizeClause as xa, TargetCaptureReasonCode as xi, PROTOCOL_V4_NOTICE as xn, classifyTaskIntent as xr, readActiveHostGraph as xt, SESSION_EVENT_ENVELOPE_INVALID as y, canonicalizePath as ya, HostStatus as yi, CAPTURE_V042_NOTICE as yn, TaskIntent as yr, packageRowsFromActiveGraph as yt, SessionQuery as z, replayRebindResult as zi, HostCapabilityRequest as zn, segmentClauses as zr, commitTreeSnapshotDigest as zt };