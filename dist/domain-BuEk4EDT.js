...
//#endregion
export { sourceItemForCoreRequirement as $, requestedTargetAuthorizesMutation as $i, decisionBoundaryKey as $n, classifyTaskIntent as $r, RC015_HOST_PACKAGES as $t, lifecyclePhase as A, presentExplanationHead as Ai, CLEANUP_CONDITION_RULE_COMPACT as An, deriveItemDiagnosis as Ar, DEFAULT_HOST_LOCK as At, snapshotSessionEvents as B, ACTION_MANIFEST_VERSION as Bi, bindingSatisfies as Bn, removalIsComplete as Br, evaluateHostLock as Bt, parseGitCommandManifest as C, kindOfScope as Ci, requiredSubjectsOf as Cn, rebindAttemptKey as Cr, parseShellCommand as Ct, claimedBatchHasRealRootInput as D, namedActions as Di, validateProofManifest as Dn, isFrozenV042RebindResponse as Dr, ALPHA2_DSHMARKET_139_HOST_PACKAGES as Dt, FIRST_STEP_GUIDANCE as E, maskQuotedSpans as Ei, sessionQueryV2 as En, CONFIRM_LINE_PATTERN as Er, ACTIVE_HOST_LAUNCHER_VERSION as Et, captureHostWorkdir as F, semanticActionOfScope as Fi, cleanupConditionFor as Fn, actionHasCertificationPath as Fr, LEGACY_HOST_COHORTS as Ft, PROTOCOL_V4_NOTICE as G, STATEFUL_ACTIONS as Gi, NO_PROGRESS_RECORD_PREFIX as Gn, environmentDefaultRepositoryTarget as Gr, MIN_SUPPORTED_HOST_VERSION as Gt, CAPTURE_V042_NOTICE as H, CERTIFICATE_VERSION as Hi, evidenceMatchesItem as Hn, captureClause as Hr, hostVersionFromPackages as Ht, sourcedNamedTestRoot as I, splitTextFragments as Ii, closingHint as In, admissibleForRemoval as Ir, bindExecutableIdentity as It, applyUpgradeEligibility as J, SUPPORTED_EVIDENCE_ADAPTERS as Ji, assessmentOutcomePredicate as Jn, extractOperation as Jr, compareHostVersions as Jt, PROTOCOL_V5_NOTICE as K, STOP_PROTOCOL_VERSION as Ki, NO_PROGRESS_TURNS_BEFORE_STOP as Kn, extractArtifactPaths as Kr, SUPPORTED_HOST_RANGE as Kt, SESSION_API_UNSUPPORTED as L, statefulActionsOfScope as Li, openItems as Ln, capabilityConsequence as Lr, bindLiveGoalCapability as Lt, projectSessionCoreV2 as M, questionHeadsClause as Mi, DEFAULT_RECOVERY_CHAR_BUDGET as Mn, itemDiagnosis as Mr, GOAL_HOST_PACKAGES as Mt, sessionCoreSnapshot as N, reportingHeadGoverns as Ni, MIN_RECOVERY_CHAR_BUDGET as Nn, relevantEvidence as Nr, HOST_CAPABILITY_PACKAGE_GROUPS as Nt, firstStepGuidance as O, opensConditionLead as Oi, validateProofManifestV2 as On, parseConfirmationMessage as Or, ALPHA2_HOST_PACKAGES as Ot, HOST_WORKDIR_PREFIX as P, restatedContentOf as Pi, carriesCleanupCondition as Pn, DEPENDENCY_FREE_ONLY_CONDITION as Pr, HOST_COHORTS as Pt, currentV6Feedback as Q, requestedIdentityKey as Qi, decideTurnStopping as Qn, npmEscapedPackageName as Qr, RC015_RC2_HOST_PACKAGES as Qt, SESSION_EVENT_ENVELOPE_INVALID as R, verbIsNegated as Ri, recoveryDigest as Rn, capabilityFactOf as Rr, evaluateExternalWaitCapability as Rt, gitCommandMatchesTarget as S, itemHoldsExecutionAuthority as Si, proofV2Rejection as Sn, proposeRebindV042 as Sr, parsePwshCommand as St, verifiedLinearCommitReadback as T, maskCodeSpans as Ti, sessionQuery as Tn, replayRebindResult as Tr, ACTIVE_HOST_COHORT_IDS as Tt, DEFAULT_DELEGATION_TOOL_NAMES as U, CERTIFICATE_VERSION_V2 as Ui, isVerifyingCapability as Un, captureItem as Ur, selectHostCohort as Ut, projectCoreV2 as V, BOUNDED_ARTIFACT_TYPES as Vi, evidenceCoverage as Vn, removalIsPartiallyKnown as Vr, evaluateToolSurfaceCapability as Vt, PROTOCOL_V3_NOTICE as W, SEMANTIC_ACTIONS as Wi, CONTROL_RECORD_PREFIX as Wn, classifyClause as Wr, LATEST_SUPPORTED_HOST_VERSION as Wt, legacyRecordsNeedingReview as X, boundedArtifactChoiceMatches as Xi, currentActionBases as Xn, segmentClauses as Xr, parseHostVersion as Xt, deriveProjection as Y, actionCompatible as Yi, classifyCompletionClaim as Yn, isInformationalMessage as Yr, evaluateMinimumHostVersion as Yt, rootLocatorFlavor as Z, isStatefulAction as Zi, decideTurnBoundary as Zn, canonicalRegistryBase as Zr, satisfiesSupportedHostRange as Zt, GIT_COMMAND_TEMPLATES as _, isExplanationScope as _i, proofDigest as _n, currentContractDigest as _r, isDeterministicCheck as _t, combineHostPolicy as a, COMMAND_SURFACE_MANIFEST as aa, clauseAsksOwnQuestion as ai, PROOF_CAPABILITY_MATRIX as an, progressFingerprint as ar, normalizeReleaseContract as at, createGitPrestateEnvelope as b, isQuestionScopeNeedingReview as bi, proofHostSurfacesOf as bn, proposeRebind as br, canonicalArgvFromCommand as bt, injectActiveProfileHostLock as c, digestStrings as ca, explanationHasActionResidue as ci, PROOF_MANIFEST_DOMAIN_V2 as cn, goalCompletionDenial as cr, readbackSettlesContract as ct, packageRowsFromPnpmLock as d, sanitizeUrl as da, hasQuestionScope as di, bindProofToProjection as dn, certificateClosure as dr, releasePreEffectDecision as dt, requestedTargetMatchesResolved as ea, classifyUserInteraction as ei, RC1_HOST_PACKAGES as en, isRootPauseRequest as er, OUTCOME_STRENGTH as et, readActiveHostGraph as f, sha256 as fa, hasWorkPredicate as fi, bindProofV2ToProjection as fn, unitDescendantIds as fr, reservationFor as ft, GIT_COMMAND_MANIFEST_IDS as g, isExecutableItem as gi, proofCapabilityReport as gn, qualifyBoundary as gr, extractToolSubject as gt, verifyComposedHostLockDump as h, introducesActionClause as hi, createProofManifestV2 as hn, isCurrentAcceptedBoundary as hr, extractTextContent as ht, auditedForegroundRenderers as i, validateActionTarget as ia, clarifiedSpanOf as ii, certifyCheckpoint as in, observeAssistantOutcome as ir, inFlightReservation as it, previewFirstStepInjection as j, qualificationOfClause as ji, CLEANUP_CONDITION_RULE_SHORT as jn, evidenceAvailabilityReason as jr, EXPECTED_HOST_PACKAGES as jt, firstStepGuidanceV6 as k, opensWithDirective as ki, CLEANUP_CONDITION_RULE as kn, capabilityRemedyPhrase as kr, BASE_HOST_PACKAGES as kt, inspectTargetHostGraph as l, normalizeClause as la, governedClauseRestrictsExecution as li, PROOF_PROTOCOL_VERSION as ln, hasCurrentCertificate as lr, releaseContractFor as lt, resolveInstalledHostLock as m, interpretMessage as mi, createProofManifest as mn, effectuateBoundary as mr, evidenceFromPersistedToolResult as mt, auditedDefaultWorkdirHost as n, semanticActionFromText as na, LEGACY_QUALIFICATION as ni, authorityCaptureCounts as nn, latestAssistantText as nr, RELEASE_OPERATION_SURFACES as nt, hostLockContextFromComposedDump as o, validateManifest as oa, clauseIsGoverned as oi, PROOF_KINDS as on, testOutcomePredicate as or, normalizeReservation as ot, resolveActiveProfileHostLock as p, interpretClause as pi, canonicalProjection as pn, availableBoundaryQualifications as pr, supersedeItem as pt, PROTOCOL_V6_NOTICE as q, STOP_PROTOCOL_VERSION_V2 as qi, assessmentAction as qn, extractMethod as qr, SUPPORTED_HOST_VERSIONS as qt, auditedDefaultWorkdirProvider as r, validateActionManifest as ra, actionVerbMatches as ri, segmentAuthorityBlocks as rn, latestRootInstruction as rr, contractById as rt, hostLockRowsFromComposedDump as s, canonicalizePath as sa, clauseIsProtected as si, PROOF_KINDS_V2 as sn, v6TestPredicate as sr, normalizeSettlement as st, HostProfileError as t, semanticActionFromCommand as ta, GRANTED_QUALIFICATION as ti, ALPHA3_HOST_PACKAGES as tn, isWholeTaskCompletionClaim as tr, RELEASE_OPERATIONS as tt, packageRowsFromActiveGraph as u, sanitizeClauseText as ua, hasOrderedCoordination as ui, PROOF_PROTOCOL_VERSION_V2 as un, certifiableOpenItems as ur, releaseCoverage as ut, commitIndexSnapshotDigest as v, isInformationalFragment as vi, proofDigestV2 as vn, createProjection as vr, persistedToolResultStatus as vt, revalidateGitPrestate as w, legacyQuestionReadingIsInformational as wi, scopeCoverageDigest as wn, rebindResponse as wr, ACTIVE_HOST_COHORT_ID as wt, executeRevalidatedGitEffect as x, isRestatement as xi, proofOperationMatches as xn, proposeRebindOutcome as xr, isRunExecutable as xt, commitTreeSnapshotDigest as y, isOpenObligation as yi, proofEvidenceConstraints as yn, confirmRebind as yr, withDurability as yt, SessionApiError as z, ACTION_MANIFEST as zi, renderRecoveryPacket as zn, partialFailureOf as zr, evaluateHostCapability as zt };