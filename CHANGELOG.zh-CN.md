...
- 增加共享 core/v2 消费端，并以源码镜像 pin 绑定 Codex Context Guard 提交 `20b938d5728d9d6a27386268a79ceeb2be5c39ce`，精确列出 fixture 与运行时 JSON 摘要；历史 v1 pin 保持不变。v6 会话边界把新运行时与旧 v5 历史记录分开。
